  ...
  <script>
    ...
    export default {
      ...
      methods: {
        ...
        initThree() {
          ...
          three.scene.add(new THREE.AmbientLight(new THREE.Color("#666666")));
   ...
   function render() {
    const time = performance.now() * 0.001;
     mesh.position.z = Math.sin(time) * 15000 + 1500;
	...
	render();
        ...
        renderThreeObj() {
          ...
          _3Dobjects.forEach((item, id) => {
            ...
            // _3Dobjects[id].threeMesh.children[0].position.z = Math.sin(time) * 15000 + 1500;
            // console.log(_3Dobjects[id].threeMesh.children[0].position.y)
            // _3Dobjects[id].threeMesh.children[0].rotation.y = time * 0.5;
            // _3Dobjects[id].threeMesh.children[0].rotation.z = time * 0.51;
