...
class RainEffect {
    ...
    constructor(Cesium:any,viewer:any, options:any) {
        ...
        //倾斜角度，负数向右，正数向左
        this.Cesium = Cesium
        this.tiltAngle = this.Cesium.defaultValue(options.tiltAngle, -.6);
        this.rainSize = this.Cesium.defaultValue(options.rainSize, 0.3);
        this.rainSpeed = this.Cesium.defaultValue(options.rainSpeed, 60.0);
        this.viewer = viewer;
        this.init();
    }
